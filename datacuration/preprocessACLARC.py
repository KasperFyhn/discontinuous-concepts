...
SAVE_DIR = datapaths.PATH_TO_ACLARC + 'annotations/'
...
def process(path):
    ...
    try:
        ...
        print('\rUnicodeDecodeError for:', path)
        new_path = datapaths.PATH_TO_ACLARC + 'problematic/' \
